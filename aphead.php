...
require"connect.php";
session_start();
 $f="select ap_place from apmc_details where ap_id=".$_SESSION['applace']."";
            $rf=mysql_query($f);
...
<?php
	...
	if ((!(isset($_SESSION["applace"]))) || (!(isset($_SESSION["pwd"]))))
	{
		header("Location: aplogin.php?b=1");
	}
?>	
...
<div class="top-navg-main">
    ...
    box-shadow: 10px 10px 5px #888488;">
	    <div class="top-navg " style="float:left;">
				...
				<ul class="res">
				<li> Krishi Bazar</li>
				    <li><a href="indexap.php" class="active hvr-sweep-to-bottom">Home</a></li> 
					<li><a class="hvr-sweep-to-bottom" href="tdetail.php">View Trader List </a></li> 
					<li><a class="hvr-sweep-to-bottom" href="apaddprice.php">Add Price</a></li> 
        ...
        <ul class="nav navbar-nav">
          <li class="dropdown user user-menu" style="margin-left: 500px">
            ...
            <ul class="dropdown-menu" style="background-color:#539DC2 ">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="approfile.php" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                  <a href="aplogout.php" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
